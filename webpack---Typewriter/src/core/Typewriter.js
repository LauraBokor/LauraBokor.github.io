...
class Typewriter {
    ...
    init() {
        ...
        this.addEventToQueue(EVENT_NAMES.CHANGE_CURSOR, {
     ...
     */
    pauseFor = (ms) => {
        this.addEventToQueue(EVENT_NAMES.PAUSE_FOR, {
            ms
        });
    ...
    deleteAll = (speed = 'natural') => {
        this.addEventToQueue(EVENT_NAMES.REMOVE_ALL, {
            speed
        });
        return this;
    }
    ...
    changeDeleteSpeed = (speed) => {
        ...
        this.addEventToQueue(EVENT_NAMES.CHANGE_DELETE_SPEED, {
            speed
        });
    ...
    changeDelay = (delay) => {
        ...
        this.addEventToQueue(EVENT_NAMES.CHANGE_DELAY, {
            delay
        });
    ...
    callFunction = (cb, thisArg) => {
        ...
        this.addEventToQueue(EVENT_NAMES.CALL_FUNCTION, {
            cb,
            thisArg
        });
